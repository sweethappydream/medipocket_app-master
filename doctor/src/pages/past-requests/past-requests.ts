...
/**
 * Generated class for the PastRequestsPage page.
 *
...
let now = new Date();
@Component({
  selector: 'page-past-requests',
  templateUrl: 'past-requests.html',
})
export class PastRequestsPage {
	user_id 									: any;
	activeorders 									: any;
	pageTitle 									: any;
	showTemplate 								: any;
	...
	filter() {
		...
		filterObj.limit  = 20;
		filterObj.request_status = "eprescription";
		this.filteredData = [];
	...
	openOrder(item: any) {
		let rxdetailsModal = this.modalCtrl.create(PrescriptionFinalizePage, {
        	order: item, 
        	create_order: {doctor_suggested_medications: item.order.doctor_suggested_medications}, 
        	create_request: {}, 
        	pagefrom: "past"
        });
        ...
        // console.log(item);
        /* this.navCtrl.push(PrescriptionFinalizePage, {
        	order: item, 
        	create_order: {doctor_suggested_medications: item.order.doctor_suggested_medications}, 
        	create_request: {}, 
        	pagefrom: "past"
