...
export class RegisterPage {
    ...
    constructor(public navCtrl: NavController, public navParams: NavParams, private formBuilder: FormBuilder, private auth: DeliveryServiceProvider, private fb: Facebook, private loginProvider:LoginProvider) {
