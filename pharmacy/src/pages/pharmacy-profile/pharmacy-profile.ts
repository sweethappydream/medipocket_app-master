...
@Component({
  selector: 'page-pharmacy-profile',
...
export class PharmacyProfilePage {
	...
	constructor(public events: Events, private changeDetector : ChangeDetectorRef, public zone: NgZone, private formBuilder: FormBuilder, public navCtrl: NavController, public navParams: NavParams, private deliveryService: DeliveryServiceProvider, private tempService: TempStorageProvider, private sanitization: DomSanitizer) {
...
updatePharmacyProfileInfo(){
//	console.log("in");
	setTimeout(() => {
		
		this.zone.run(() => {
		//	console.log(this.profileInfo);
			this.tempService.pharmacyInfo.pharmacy_name = this.profileInfo.pharmacy_name;
			this.tempService.pharmacyInfo.pharmacy_address = this.profileInfo.address;
			this.tempService.pharmacyInfo.pharmacy_country = this.profileInfo.countryname;
			this.tempService.pharmacyInfo.pharmacy_state = this.profileInfo.statename;
			this.tempService.pharmacyInfo.pharmacy_city = this.profileInfo.cityname;
			this.tempService.pharmacyInfo.pharmacy_zip = this.profileInfo.zip_code;
		...
		this.deliveryService.updateProfileInfo(Objs, this.user_id).then((result)=>{
			...
			if(resultData.data !== undefined){
			 ...
			 setTimeout(()=>{
				...
				this.updatePharmacyProfileInfo();
						...
						this.profileFormData.patchValue(
							{
								...
								pharmacy_name: this.profileInfo.pharmacy_name,
